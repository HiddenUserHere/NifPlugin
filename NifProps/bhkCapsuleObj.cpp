...
int CapsuleObjCreateCallBack::proc(ViewExp *vpt,int msg, int point, int flags, IPoint2 m, Matrix3& mat ) 
{
   ...
   if (msg==MOUSE_POINT||msg==MOUSE_MOVE) 
   {
      ...
      case 0:  // only happens with MOUSE_POINT msg
         ...
         ob->GetParamBlock( 0 )->SetValue(PB_RADIUS1,0,0.0f);
         ob->GetParamBlock( 0 )->SetValue(PB_RADIUS2,0,0.0f);
      ...
      case 1: // Fix radius of first cap
         ...
         ob->GetParamBlock( 0 )->SetValue(PB_RADIUS1,0,r);
         ob->GetParamBlock( 0 )->SetValue(PB_RADIUS2,0,r);
      ...
      case 2: // Get second point
         ...
         ob->GetParamBlock( 0 )->SetValue(PB_LENGTH,0,r);
         ob->pmapParam->Invalidate();
